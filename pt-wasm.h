...
#define PT_WASM_OP_DEFS \
  ...
  /* 0x06 */ PT_WASM_OP_RESERVED(RESERVED_06, "reserved.06") \
  /* 0x07 */ PT_WASM_OP_RESERVED(RESERVED_07, "reserved.07") \
  ...
  /* 0x12 */ PT_WASM_OP_RESERVED(RESERVED_12, "reserved.12") \
  /* 0x13 */ PT_WASM_OP_RESERVED(RESERVED_13, "reserved.13") \
  /* 0x14 */ PT_WASM_OP_RESERVED(RESERVED_14, "reserved.14") \
  /* 0x15 */ PT_WASM_OP_RESERVED(RESERVED_15, "reserved.15") \
  /* 0x16 */ PT_WASM_OP_RESERVED(RESERVED_16, "reserved.16") \
  /* 0x17 */ PT_WASM_OP_RESERVED(RESERVED_17, "reserved.17") \
  /* 0x18 */ PT_WASM_OP_RESERVED(RESERVED_18, "reserved.18") \
  /* 0x19 */ PT_WASM_OP_RESERVED(RESERVED_19, "reserved.19") \
  /* 0x1A */ PT_WASM_OP(DROP, "drop", NONE) \
  /* 0x1B */ PT_WASM_OP(SELECT, "select", NONE) \
  /* 0x1C */ PT_WASM_OP_RESERVED(RESERVED_1C, "reserved.1c") \
  /* 0x1D */ PT_WASM_OP_RESERVED(RESERVED_1D, "reserved.1d") \
  /* 0x1E */ PT_WASM_OP_RESERVED(RESERVED_1E, "reserved.1e") \
  /* 0x1F */ PT_WASM_OP_RESERVED(RESERVED_1F, "reserved.1f") \
  ...
  /* 0x27 */ PT_WASM_OP_RESERVED(RESERVED_27, "reserved.27") \
  ...
  /* 0xC0 */ PT_WASM_OP_RESERVED(RESERVED_C0, "reserved.c0") \
  /* 0xC1 */ PT_WASM_OP_RESERVED(RESERVED_C1, "reserved.c1") \
  /* 0xC2 */ PT_WASM_OP_RESERVED(RESERVED_C2, "reserved.c2") \
  /* 0xC3 */ PT_WASM_OP_RESERVED(RESERVED_C3, "reserved.c3") \
  /* 0xC4 */ PT_WASM_OP_RESERVED(RESERVED_C4, "reserved.c4") \
  /* 0xC5 */ PT_WASM_OP_RESERVED(RESERVED_C5, "reserved.c5") \
  /* 0xC6 */ PT_WASM_OP_RESERVED(RESERVED_C6, "reserved.c6") \
  /* 0xC7 */ PT_WASM_OP_RESERVED(RESERVED_C7, "reserved.c7") \
  /* 0xC8 */ PT_WASM_OP_RESERVED(RESERVED_C8, "reserved.c8") \
  /* 0xC9 */ PT_WASM_OP_RESERVED(RESERVED_C9, "reserved.c9") \
  /* 0xCA */ PT_WASM_OP_RESERVED(RESERVED_CA, "reserved.ca") \
  /* 0xCB */ PT_WASM_OP_RESERVED(RESERVED_CB, "reserved.cb") \
  /* 0xCC */ PT_WASM_OP_RESERVED(RESERVED_CC, "reserved.cc") \
  /* 0xCD */ PT_WASM_OP_RESERVED(RESERVED_CD, "reserved.cd") \
  /* 0xCE */ PT_WASM_OP_RESERVED(RESERVED_CE, "reserved.ce") \
  /* 0xCF */ PT_WASM_OP_RESERVED(RESERVED_CF, "reserved.cf") \
  /* 0xD0 */ PT_WASM_OP_RESERVED(RESERVED_D0, "reserved.d0") \
  /* 0xD1 */ PT_WASM_OP_RESERVED(RESERVED_D1, "reserved.d1") \
  /* 0xD2 */ PT_WASM_OP_RESERVED(RESERVED_D2, "reserved.d2") \
  /* 0xD3 */ PT_WASM_OP_RESERVED(RESERVED_D3, "reserved.d3") \
  /* 0xD4 */ PT_WASM_OP_RESERVED(RESERVED_D4, "reserved.d4") \
  /* 0xD5 */ PT_WASM_OP_RESERVED(RESERVED_D5, "reserved.d5") \
  /* 0xD6 */ PT_WASM_OP_RESERVED(RESERVED_D6, "reserved.d6") \
  /* 0xD7 */ PT_WASM_OP_RESERVED(RESERVED_D7, "reserved.d7") \
  /* 0xD8 */ PT_WASM_OP_RESERVED(RESERVED_D8, "reserved.d8") \
  /* 0xD9 */ PT_WASM_OP_RESERVED(RESERVED_D9, "reserved.d9") \
  /* 0xDA */ PT_WASM_OP_RESERVED(RESERVED_DA, "reserved.da") \
  /* 0xDB */ PT_WASM_OP_RESERVED(RESERVED_DB, "reserved.db") \
  /* 0xDC */ PT_WASM_OP_RESERVED(RESERVED_DC, "reserved.dc") \
  /* 0xDD */ PT_WASM_OP_RESERVED(RESERVED_DD, "reserved.dd") \
  /* 0xDE */ PT_WASM_OP_RESERVED(RESERVED_DE, "reserved.de") \
  /* 0xDF */ PT_WASM_OP_RESERVED(RESERVED_DF, "reserved.df") \
  /* 0xE0 */ PT_WASM_OP_RESERVED(RESERVED_E0, "reserved.e0") \
  /* 0xE1 */ PT_WASM_OP_RESERVED(RESERVED_E1, "reserved.e1") \
  /* 0xE2 */ PT_WASM_OP_RESERVED(RESERVED_E2, "reserved.e2") \
  /* 0xE3 */ PT_WASM_OP_RESERVED(RESERVED_E3, "reserved.e3") \
  /* 0xE4 */ PT_WASM_OP_RESERVED(RESERVED_E4, "reserved.e4") \
  /* 0xE5 */ PT_WASM_OP_RESERVED(RESERVED_E5, "reserved.e5") \
  /* 0xE6 */ PT_WASM_OP_RESERVED(RESERVED_E6, "reserved.e6") \
  /* 0xE7 */ PT_WASM_OP_RESERVED(RESERVED_E7, "reserved.e7") \
  /* 0xE8 */ PT_WASM_OP_RESERVED(RESERVED_E8, "reserved.e8") \
  /* 0xE9 */ PT_WASM_OP_RESERVED(RESERVED_E9, "reserved.e9") \
  /* 0xEA */ PT_WASM_OP_RESERVED(RESERVED_EA, "reserved.ea") \
  /* 0xEB */ PT_WASM_OP_RESERVED(RESERVED_EB, "reserved.eb") \
  /* 0xEC */ PT_WASM_OP_RESERVED(RESERVED_EC, "reserved.ec") \
  /* 0xED */ PT_WASM_OP_RESERVED(RESERVED_ED, "reserved.ed") \
  /* 0xEE */ PT_WASM_OP_RESERVED(RESERVED_EE, "reserved.ee") \
  /* 0xEF */ PT_WASM_OP_RESERVED(RESERVED_EF, "reserved.ef") \
  /* 0xF0 */ PT_WASM_OP_RESERVED(RESERVED_F0, "reserved.f0") \
  /* 0xF1 */ PT_WASM_OP_RESERVED(RESERVED_F1, "reserved.f1") \
  /* 0xF2 */ PT_WASM_OP_RESERVED(RESERVED_F2, "reserved.f2") \
  /* 0xF3 */ PT_WASM_OP_RESERVED(RESERVED_F3, "reserved.f3") \
  /* 0xF4 */ PT_WASM_OP_RESERVED(RESERVED_F4, "reserved.f4") \
  /* 0xF5 */ PT_WASM_OP_RESERVED(RESERVED_F5, "reserved.f5") \
  /* 0xF6 */ PT_WASM_OP_RESERVED(RESERVED_F6, "reserved.f6") \
  /* 0xF7 */ PT_WASM_OP_RESERVED(RESERVED_F7, "reserved.f7") \
  /* 0xF8 */ PT_WASM_OP_RESERVED(RESERVED_F8, "reserved.f8") \
  /* 0xF9 */ PT_WASM_OP_RESERVED(RESERVED_F9, "reserved.f9") \
  /* 0xFA */ PT_WASM_OP_RESERVED(RESERVED_FA, "reserved.fa") \
  /* 0xFB */ PT_WASM_OP_RESERVED(RESERVED_FB, "reserved.fb") \
  /* 0xFC */ PT_WASM_OP_RESERVED(RESERVED_FC, "reserved.fc") \
  /* 0xFD */ PT_WASM_OP_RESERVED(RESERVED_FD, "reserved.fd") \
  /* 0xFE */ PT_WASM_OP_RESERVED(RESERVED_FE, "reserved.fe") \
