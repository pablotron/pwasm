...
#define PT_WASM_SECTION_TYPES \
  ...
  PT_WASM_SECTION_TYPE(LAST, invalid)
...
#define PT_WASM_OP_DEFS \
  ...
  /* 0x06 */ PT_WASM_OP_RESERVED(_06, "06") \
  /* 0x07 */ PT_WASM_OP_RESERVED(_07, "07") \
  /* 0x08 */ PT_WASM_OP_RESERVED(_08, "08") \
  /* 0x09 */ PT_WASM_OP_RESERVED(_09, "09") \
  /* 0x0A */ PT_WASM_OP_RESERVED(_0A, "0A") \
  ...
  /* 0x12 */ PT_WASM_OP_RESERVED(_12, "12") \
  /* 0x13 */ PT_WASM_OP_RESERVED(_13, "13") \
  /* 0x14 */ PT_WASM_OP_RESERVED(_14, "14") \
  /* 0x15 */ PT_WASM_OP_RESERVED(_15, "15") \
  /* 0x16 */ PT_WASM_OP_RESERVED(_16, "16") \
  /* 0x17 */ PT_WASM_OP_RESERVED(_17, "17") \
  /* 0x18 */ PT_WASM_OP_RESERVED(_18, "18") \
  /* 0x19 */ PT_WASM_OP_RESERVED(_19, "19") \
  /* 0x1A */ PT_WASM_OP(DROP, "drop", NONE) \
  /* 0x1B */ PT_WASM_OP(SELECT, "select", NONE) \
  /* 0x1C */ PT_WASM_OP_RESERVED(_1C, "1c") \
  /* 0x1D */ PT_WASM_OP_RESERVED(_1D, "1d") \
  /* 0x1E */ PT_WASM_OP_RESERVED(_1E, "1e") \
  /* 0x1F */ PT_WASM_OP_RESERVED(_1F, "1f") \
  ...
  /* 0x25 */ PT_WASM_OP_RESERVED(_25, "25") \
  /* 0x26 */ PT_WASM_OP_RESERVED(_26, "26") \
  /* 0x27 */ PT_WASM_OP_RESERVED(_27, "27") \
  ...
  /* 0xC0 */ PT_WASM_OP_RESERVED(_C0, "c0") \
  /* 0xC1 */ PT_WASM_OP_RESERVED(_C1, "c1") \
  /* 0xC2 */ PT_WASM_OP_RESERVED(_C2, "c2") \
  /* 0xC3 */ PT_WASM_OP_RESERVED(_C3, "c3") \
  /* 0xC4 */ PT_WASM_OP_RESERVED(_C4, "c4") \
  /* 0xC5 */ PT_WASM_OP_RESERVED(_C5, "c5") \
  /* 0xC6 */ PT_WASM_OP_RESERVED(_C6, "c6") \
  /* 0xC7 */ PT_WASM_OP_RESERVED(_C7, "c7") \
  /* 0xC8 */ PT_WASM_OP_RESERVED(_C8, "c8") \
  /* 0xC9 */ PT_WASM_OP_RESERVED(_C9, "c9") \
  /* 0xCA */ PT_WASM_OP_RESERVED(_CA, "ca") \
  /* 0xCB */ PT_WASM_OP_RESERVED(_CB, "cb") \
  /* 0xCC */ PT_WASM_OP_RESERVED(_CC, "cc") \
  /* 0xCD */ PT_WASM_OP_RESERVED(_CD, "cd") \
  /* 0xCE */ PT_WASM_OP_RESERVED(_CE, "ce") \
  /* 0xCF */ PT_WASM_OP_RESERVED(_CF, "cf") \
  /* 0xD0 */ PT_WASM_OP_RESERVED(_D0, "d0") \
  /* 0xD1 */ PT_WASM_OP_RESERVED(_D1, "d1") \
  /* 0xD2 */ PT_WASM_OP_RESERVED(_D2, "d2") \
  /* 0xD3 */ PT_WASM_OP_RESERVED(_D3, "d3") \
  /* 0xD4 */ PT_WASM_OP_RESERVED(_D4, "d4") \
  /* 0xD5 */ PT_WASM_OP_RESERVED(_D5, "d5") \
  /* 0xD6 */ PT_WASM_OP_RESERVED(_D6, "d6") \
  /* 0xD7 */ PT_WASM_OP_RESERVED(_D7, "d7") \
  /* 0xD8 */ PT_WASM_OP_RESERVED(_D8, "d8") \
  /* 0xD9 */ PT_WASM_OP_RESERVED(_D9, "d9") \
  /* 0xDA */ PT_WASM_OP_RESERVED(_DA, "da") \
  /* 0xDB */ PT_WASM_OP_RESERVED(_DB, "db") \
  /* 0xDC */ PT_WASM_OP_RESERVED(_DC, "dc") \
  /* 0xDD */ PT_WASM_OP_RESERVED(_DD, "dd") \
  /* 0xDE */ PT_WASM_OP_RESERVED(_DE, "de") \
  /* 0xDF */ PT_WASM_OP_RESERVED(_DF, "df") \
  /* 0xE0 */ PT_WASM_OP_RESERVED(_E0, "e0") \
  /* 0xE1 */ PT_WASM_OP_RESERVED(_E1, "e1") \
  /* 0xE2 */ PT_WASM_OP_RESERVED(_E2, "e2") \
  /* 0xE3 */ PT_WASM_OP_RESERVED(_E3, "e3") \
  /* 0xE4 */ PT_WASM_OP_RESERVED(_E4, "e4") \
  /* 0xE5 */ PT_WASM_OP_RESERVED(_E5, "e5") \
  /* 0xE6 */ PT_WASM_OP_RESERVED(_E6, "e6") \
  /* 0xE7 */ PT_WASM_OP_RESERVED(_E7, "e7") \
  /* 0xE8 */ PT_WASM_OP_RESERVED(_E8, "e8") \
  /* 0xE9 */ PT_WASM_OP_RESERVED(_E9, "e9") \
  /* 0xEA */ PT_WASM_OP_RESERVED(_EA, "ea") \
  /* 0xEB */ PT_WASM_OP_RESERVED(_EB, "eb") \
  /* 0xEC */ PT_WASM_OP_RESERVED(_EC, "ec") \
  /* 0xED */ PT_WASM_OP_RESERVED(_ED, "ed") \
  /* 0xEE */ PT_WASM_OP_RESERVED(_EE, "ee") \
  /* 0xEF */ PT_WASM_OP_RESERVED(_EF, "ef") \
  /* 0xF0 */ PT_WASM_OP_RESERVED(_F0, "f0") \
  /* 0xF1 */ PT_WASM_OP_RESERVED(_F1, "f1") \
  /* 0xF2 */ PT_WASM_OP_RESERVED(_F2, "f2") \
  /* 0xF3 */ PT_WASM_OP_RESERVED(_F3, "f3") \
  /* 0xF4 */ PT_WASM_OP_RESERVED(_F4, "f4") \
  /* 0xF5 */ PT_WASM_OP_RESERVED(_F5, "f5") \
  /* 0xF6 */ PT_WASM_OP_RESERVED(_F6, "f6") \
  /* 0xF7 */ PT_WASM_OP_RESERVED(_F7, "f7") \
  /* 0xF8 */ PT_WASM_OP_RESERVED(_F8, "f8") \
  /* 0xF9 */ PT_WASM_OP_RESERVED(_F9, "f9") \
  /* 0xFA */ PT_WASM_OP_RESERVED(_FA, "fa") \
  /* 0xFB */ PT_WASM_OP_RESERVED(_FB, "fb") \
  /* 0xFC */ PT_WASM_OP_RESERVED(_FC, "fc") \
  /* 0xFD */ PT_WASM_OP_RESERVED(_FD, "fd") \
